    ...
    <div class="col-10">
        <p class="text-center p-3 row" style="font-family: 'Comic Sans MS',cursive;font-weight: bold;font-size: 20px">
            ...
            <c:if test="${message!=null}">
                <span class="text-primary ml-3">${message}</span>
            </c:if>
        </p>
        <p class="text-center p-3 row" style="font-family: 'Comic Sans MS',cursive;font-weight: bold;font-size: 20px">
            <button><a href="/student?action=create" methods="get">Create Student</a></button>
        </p>
        <table id="tabletable" class="table table-bordered table-striped ">
            ...
            <tbody>
            <c:forEach items="${students}" var="student" varStatus="a">
                <tr>
                    <td>${a.count}</td>
