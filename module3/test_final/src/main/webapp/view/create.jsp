...
<div class="container-fluid d-flex " style="background: #e6faf8">
    ...
    <div class="col-8">
        <span style="font-family: 'Comic Sans MS',cursive;font-weight: bold;font-size: 20px">Them moi</span>
        <form action="/sanPham?action=create" method="post" class="container border border-dark mb-3 pt-3">


            <div class="form-group">
                <label>Ten:</label>
                <input type="text" class="form-control" placeholder="nhap ten" name="ten">
            </div>

            <div class="form-group">
                <label>gia:</label>
                <input type="number" class="form-control" placeholder="nhap gia" name="gia">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" placeholder="nhap so luong" name="soLuong">
            </div>


            <div class="form-group">
                <label>mau sac</label>
                <input type="text" class="form-control" placeholder="nhap mau sac" name="mauSac">
            </div>


            <div class="form-group">
                <label>mo ta</label>
                <input type="text" class="form-control" placeholder="nhap mo ta" name="moTa">
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="danhMuc">
                    <c:forEach var="danhMuc" items="${danhMucs}">
                        <option value="${danhMuc.danhMuc}">${danhMuc.tenDanhMuc}</option>
                    </c:forEach>
                </select>
            </div>
