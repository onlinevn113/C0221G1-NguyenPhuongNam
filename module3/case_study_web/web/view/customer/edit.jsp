...
<div class="container-fluid d-flex " style="background: #e6faf8">
    ...
    <div class="col-8">
        ...
        <form action="/customer?action=edit&id=${customer.idCustomer}" method="post">
            <div class="form-group">
                <label>Id Customer</label>
                <input disabled type="text" value="${customer.idCustomer}" class="form-control" >
            </div>
            <div class="form-group">
                <label>Enter idTypeCustomer</label>
                <input type="text" name="idTypeCustomer" class="form-control" value="${customer.idTypeCustomer}" >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="dateOfBirth" class="form-control" value="${customer.dateOfBirth}" >
            </div>

            <div class="form-group">
                <label>Enter sex</label>
                <input type="text" name="sex" class="form-control" value="${customer.sex}"  >
            </div>


            <div class="form-group">
                <label>Enter idCard</label>
