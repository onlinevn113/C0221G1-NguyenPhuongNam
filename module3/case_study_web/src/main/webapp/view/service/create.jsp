    ...
    <div class="col-8">
        ...
        <form action="/service?action=create" method="post" class="container border border-dark mb-3 pt-3">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter standardRoom " name="standardRoom">
            </div>
            <div class="form-group">
                <label>descriptionOtherConvenience: </label>
                <input type="text" class="form-control" placeholder="Enter descriptionOtherConvenience "
                       name="descriptionOtherConvenience">
            </div>
            <div class="form-group">
                <label>poolArea: </label>
                <input type="number" class="form-control" placeholder="Enter poolArea" name="poolArea">
            </div>
            <div class="form-group">
                <label>numberOfFloors: </label>
                <input type="number" class="form-control" placeholder="Enter numberOfFloors" name="numberOfFloors">
            </div>
