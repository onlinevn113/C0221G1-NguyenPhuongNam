...
<div class="container-fluid d-flex " style="background: #e6faf8">
    ...
    <div class="col-8">
        ...
        <form action="/contract?action=createContract" method="post" class="container border border-dark mb-3 pt-3">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="customerId">
                    <c:forEach var="customer" items="${customerList}">
                        <option value="${customer.idCustomer}">${customer.idCustomer}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" placeholder="Enter contractStartDate" name="contractStartDate">
            </div>
            <div class="form-group">
                <label>contractEndDate:</label>
                <input type="date" class="form-control" placeholder="Enter contractEndDate" name="contractEndDate">
            </div>

            <div class="form-group">
                <label>contractDeposit: </label>
                <input type="number" class="form-control" placeholder="Enter contractDeposit" name="contractDeposit">
            </div>
            <div class="form-group">
                <label>contractTotal: </label>
                <input type="number" class="form-control" placeholder="Enter contractTotal" name="contractTotal">
            </div>
