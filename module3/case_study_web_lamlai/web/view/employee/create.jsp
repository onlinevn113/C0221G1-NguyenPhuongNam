...
<div class="container-fluid d-flex " style="background: #e6faf8">
    ...
    <div class="col-8">
        <span style="font-family: 'Comic Sans MS',cursive;font-weight: bold;font-size: 20px">CREATE EMPLOYEE</span>
        <form action="/employee?action=create" method="post" class="container border border-dark mb-3 pt-3">
            ...
            <div class="form-group">
                <label>Salary: </label>
                <input type="text" class="form-control" placeholder="Enter salary " name="employeeSalary">
            </div>
            <div class="form-group">
