...
<div class="container-fluid d-flex " style="background: #e6faf8">
    ...
    <div class="col-8">
        ...
        <form action="/service?action=edit&id=${service.serviceId}" method="post"
              class="container border border-dark mb-3 pt-3">

            <div class="form-group">
                <label>ID:</label>
                <input type="text" class="form-control" value="${service.serviceId}" disabled>
            </div>
            <div class="form-group">
                <label>Name:</label>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="serviceArea" value="${service.serviceArea}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="serviceMaxPeople" value="${service.serviceMaxPeople}">
            </div>

            <div class="form-group">
                <label>rentType ID: </label>
                <select class="form-control" name="rentTypeId">
                    <c:forEach var="rentType" items="${rentTypeList}">
                        <option value="${rentType.rentTypeId}" ${rentType.rentTypeId==service.rentTypeId?"selected":""}>${rentType.rentTypeName}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="form-group">
                <label>serviceType ID: </label>
                <select class="form-control" name="serviceTypeId">
                    <c:forEach var="serviceType" items="${serviceTypeList}">
                        <option value="${serviceType.serviceTypeId}" ${serviceType.serviceTypeId==service.serviceTypeId?"selected":""}>${serviceType.serviceTypeName}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-group">
                <label>descriptionOtherConvenience:</label>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="poolArea" value="${service.poolArea}">
            </div>

            <div class="form-group">
                <label>numberOfFloors:</label>
                <input type="number" class="form-control" name="numberOfFloors" value="${service.numberOfFloors}">
            </div>
