...
public class ExceptionValidate extends Exception {
    ...
    public static final String RegexVietNameseName1 = "^[A-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪỬỮỰỲỴÝỶỸ]([a-zàáâãèéêìíòóôõùúăđĩũơưăạảấầẩẫậắằẳẵặẹẻẽềềểễệỉịọỏốồổỗộớờởỡợụủứừửữựỳỵỷỹ]*[\\s]?)+$";
...
//        kiemTraThuocTinhNhapVao("Tên",RegexVietNameseName);
        while (true){
            ...
            System.out.println(str.matches(RegexVietNameseName1));
        }
    }
}
